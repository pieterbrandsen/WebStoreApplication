...
namespace WebStore.Pages.Products
{
    public class ProductEditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string Id)
        {
            ...
            var directoryPath = Path.Combine(_environment.ContentRootPath, "wwwroot", "Products", Id);
            ...
            if (Upload != null)
            {
                ...
                product.FilePath = Path.Combine("Products", Id, Path.GetFileName(file));
            }
            ...
            if (Upload2 != null)
            {
                ...
                product.FilePath2 = Path.Combine("Products", Id, Path.GetFileName(file));
            }
            ...
            if (Upload3 != null)
            {
                ...
                product.FilePath3 = Path.Combine("Products", Id, Path.GetFileName(file));
            }
            ...
            if (Upload4 != null)
            {
                ...
                product.FilePath4 = Path.Combine("Products", Id, Path.GetFileName(file));
            }
            ...
            if (Upload5 != null)
            {
                ...
                product.FilePath5 = Path.Combine("Products", Id, Path.GetFileName(file));
            }
